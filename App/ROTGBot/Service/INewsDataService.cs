...
namespace ROTGBot.Service
{
    public interface INewsDataService
    {
        ...
        Task<AdminModeratorReport> GetAdminModeratorReport(ModeratorReportFilter filter, CancellationToken token);
        Task<ModeratorReport> GetModeratorReport(Guid id, ModeratorReportFilter filter, CancellationToken token);
        Task<UserReport> GetUserReport(Guid id, UserReportFilter filter, CancellationToken token);
    }
}